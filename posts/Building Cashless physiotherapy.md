...
I was charged with shipping Cashless Physiotherapy end-to-end  from a blank slate to production as soon as possible and this is the story of how that happened.
...
The **end user** booking and attending sessions through our consumer app. The **physiotherapist partners** managing orders, uploading session plans, and raising invoices through our partner dashboard (Kea). The **in-house doctor team** verifying and digitising prescriptions through their own panel. The **operations and support team** managing the entire order lifecycle through an internal dashboard. And the **insurer or corporate sponsor** who's paying for the service and needs documented proof of every session before they release coverage.
...
The first iteration of the consumer app designs went through the same gauntlet — back to every stakeholder for review and approval. This cycle took another couple of months, with multiple iterations. Then came a demo with the MD & CEO, who liked the overall journey but wanted the UI to be more *salesy* — he wanted the interface itself to nudge users toward booking more sessions, rather than relying on the ops team to drive utilization.

![[Figma Designs.png|350]]
...
**Communication templates & amplitude events** - every touchpoint in the user journey needed templated communications across email, SMS, and push notifications along with tracking events setup for us to analyse user behaviour.
...
![[7-11-25 Bug Fixes before Prod Movt.png]]
...
Cashless Physiotherapy went live on production for Android and iOS across several large corporate and insurance sponsors in early 2026. The web app followed shortly after once the remaining bug fixes were resolved.

![[22-01-26 Live Slack Message.png]]
